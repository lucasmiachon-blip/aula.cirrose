...
| `aulas/cirrose/cirrose.css` | **CSS único** — tokens, stages, componentes, per-slide |
...
5. NUNCA inventar dados clínicos. Sem Tier 1 → `[TBD]`. CSS single-file: cirrose.css.
...
- `aulas/cirrose/cirrose.css` (seção `:root`) — tokens OKLCH, tipografia, spacing. Ler ao precisar valores exatos.
