...
> Histórico completo disponível via `git log`. Este arquivo mantém apenas o período ativo.
> Entradas anteriores a Março 2026 foram removidas em 2026-03-24 (redução de infra).
