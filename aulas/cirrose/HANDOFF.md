...
**QA scripts:** Validados end-to-end (29/mar). Pendente: checks C1-C7 e Gate 4 parsing contra producao real.
...
| 7 | s-a1-elasto | CONTENT | Criado 29/mar, bugfix 30/mar. 3 beats OK. Pendente: QA pipeline. |
...
**Resumo:** 6 DONE* · 0 QA · 38 CONTENT (44 total)
**Proximo:** s-a1-elasto QA pipeline (screenshots → Gate 0 → Gate 2 → Gate 4). Depois: s-a1-damico.
...
3. **s-a1-elasto → s-cp1** — sequencia manifest, slide a slide
