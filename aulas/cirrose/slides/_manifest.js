...
export const slides = [
  ...
  { id: 's-a1-classify', file: '02c-a1-classify.html', act: 'A1', archetype: 'hero-stat', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Classificar antes da 1a descompensacao reduz eventos', panelState: 'neutral', clickReveals: 1, customAnim: 's-a1-classify', timing: 90, narrativeRole: 'setup', tensionLevel: 2, narrativeCritical: false },
  ...
  { id: 's-a1-baveno', file: '03-a1-baveno.html', act: 'A1', archetype: 'hero-stat', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Doenca hepatica avancada e espectro, nao diagnostico binario', panelState: 'neutral', clickReveals: 2, customAnim: 's-a1-baveno', timing: 120, narrativeRole: 'setup', tensionLevel: 1, narrativeCritical: false },
