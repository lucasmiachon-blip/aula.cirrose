...
export const slides = [
  // ── Pre-Act ──
  { id: 's-title', file: '00-title.html', act: null, archetype: 'title', sectionTag: null, headline: 'Cirrose Hepatica', panelState: 'hidden', clickReveals: 0, customAnim: null, timing: null, subItems: ['brasao', 'titulo', 'pilares'] },
  ...
  { id: 's-a1-damico', file: '02b-a1-damico.html', act: 'A1', archetype: 'flow', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Tres geracoes de escores', panelState: 'neutral', clickReveals: 2, customAnim: 's-a1-damico', timing: 120 },
  ...
  { id: 's-a1-elasto', file: '03c-a1-elasto.html', act: 'A1', archetype: 'flow', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Hoje biopsia e a excecao', panelState: 'neutral', clickReveals: 0, customAnim: null, timing: 90 },
  { id: 's-a1-rule5', file: '03d-a1-rule5.html', act: 'A1', archetype: 'flow', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Rule-of-5: cada 5 kPa muda a conduta', panelState: 'neutral', clickReveals: 2, customAnim: 's-a1-rule5', timing: 120 },
  ...
  { id: 's-a2-infec', file: '05-a1-infeccao.html', act: 'A2', archetype: 'bars', sectionTag: 'ATO 2 — INTERVIR', headline: 'Infeccao precipita 1 em 3 descompensacoes — e a mais prevenivel', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  ...
  { id: 's-a2-05', file: '12-a2-hrs.html', act: 'A2', archetype: 'tree', sectionTag: 'ATO 2 — INTERVIR', headline: 'HRS-AKI: 3 perguntas antes da terlipressina — a 3a decisao', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-a2-06', file: '13-a2-he.html', act: 'A2', archetype: 'pillars', sectionTag: 'ATO 2 — INTERVIR', headline: 'Encefalopatia: lactulose + rifaximina + nutricao — NAO restringir proteina', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  ...
  { id: 's-cp3', file: '18-cp3.html', act: 'CP', archetype: 'checkpoint', sectionTag: null, headline: 'SVR + abstinencia, LSM 32→18. Pode sair da vigilancia? Da fila?', panelState: 'hope', clickReveals: 0, customAnim: null, timing: 150 },
  { id: 's-close', file: '19-close.html', act: null, archetype: 'recap', sectionTag: null, headline: '5 numeros classificaram. 3 decisoes salvaram. Cirrose nao e sentenca.', panelState: 'resolved', clickReveals: 0, customAnim: null, timing: null },

  // ── Appendix ──
  { id: 's-app-01', file: '20-app-aclf.html', act: 'APP', archetype: 'table', sectionTag: 'APENDICE', headline: 'ACLF grau 3: mortalidade 28d >70% — limiar de futilidade', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-02', file: '21-app-tips.html', act: 'APP', archetype: 'flow', sectionTag: 'APENDICE', headline: 'Early TIPS em 72h: Child C 10-13 ou B com sangramento ativo — NNT 4 (IC 95% 2,1-50)', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-03', file: '22-app-abcw.html', act: 'APP', archetype: 'table', sectionTag: 'APENDICE', headline: 'Etiologias raras: ABCW — pista clinica e exame-chave', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-04', file: '23-app-nsbb.html', act: 'APP', archetype: 'compare', sectionTag: 'APENDICE', headline: 'Turco 2024 IPD: NSBB >= EVL — carvedilol superior em HVPG', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-05', file: '24-app-ccc.html', act: 'APP', archetype: 'criteria', sectionTag: 'APENDICE', headline: 'Cardiomiopatia cirrotica: 48% prevalencia — CCC 2019 detecta mais', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-06', file: '25-app-pulm.html', act: 'APP', archetype: 'compare', sectionTag: 'APENDICE', headline: 'SHP vs HPP: fisiopatologia oposta — manejo diferente', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-07', file: '26-app-estatina.html', act: 'APP', archetype: 'compare', sectionTag: 'APENDICE', headline: 'Estatina adjuvante: HVPG -2 mmHg — LIVERHOPE negativo', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-08', file: '27-app-cirrox.html', act: 'APP', archetype: 'compare', sectionTag: 'APENDICE', headline: 'CIRROXABAN 2025: p=0,058 NS — aguardar confirmacao', panelState: null, clickReveals: 0, customAnim: null, timing: null },
  { id: 's-app-etio', file: '06-a1-etiologias.html', act: 'APP', archetype: 'table', sectionTag: 'APENDICE', headline: '"Cirrose" nao e uma doenca — sao 10 doencas com final comum', panelState: null, clickReveals: 0, customAnim: null, timing: null },
];
