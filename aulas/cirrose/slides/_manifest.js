 ...
 * Atualizado: 2026-03-14 — Headline sync: 39 headlines aligned with HTML h2 (29 cosmetic + 9 structural + 1 accent fix)
 */
...
export const slides = [
  ...
  // ── Act 1: CLASSIFICAR ──
  { id: 's-a1-01', file: '02-a1-continuum.html', act: 'A1', archetype: 'hero-stat', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Rastreio na atenção primária detecta hepatopatia antes da descompensação', panelState: 'neutral', clickReveals: 1, customAnim: 's-a1-01', timing: 90, narrativeRole: 'setup', tensionLevel: 2, narrativeCritical: false },
  ...
  { id: 's-a1-damico', file: '02b-a1-damico.html', act: 'A1', archetype: 'flow', sectionTag: 'ATO 1 — CLASSIFICAR', headline: 'Do CTP ao D\'Amico: prognóstico passou de subjetivo a preditivo', panelState: 'neutral', clickReveals: 2, customAnim: 's-a1-damico', timing: 120, narrativeRole: 'setup', tensionLevel: 2, narrativeCritical: false },
  ...
  { id: 's-a3-01', file: '37-a3-bridge.html', act: 'A3', archetype: 'hero-stat', sectionTag: 'ATO 3 — REVERTER', headline: 'Apos ascite como 1a descompensacao, cura etiologica reduziu nova descompensacao (HR 0,46) e mortalidade (HR 0,35)', panelState: null, clickReveals: 0, customAnim: null, timing: null, narrativeRole: 'payoff', tensionLevel: 2, narrativeCritical: false },
  ...
  { id: 's-a3-03', file: '38-a3-expandido.html', act: 'A3', archetype: 'compare', sectionTag: 'ATO 3 — REVERTER', headline: 'Criterio expandido ampliou o grupo para 37,6% — sem pior prognostico na coorte de validacao', panelState: null, clickReveals: 0, customAnim: null, timing: null, narrativeRole: 'payoff', tensionLevel: 2, narrativeCritical: false },
  { id: 's-a3-04', file: '39-a3-etiologia.html', act: 'A3', archetype: 'compare', sectionTag: 'ATO 3 — REVERTER', headline: 'A chance de recompensar muda com a etiologia: HBV >50%, HCV ~37%, alcool menor', panelState: null, clickReveals: 0, customAnim: null, timing: null, narrativeRole: 'payoff', tensionLevel: 2, narrativeCritical: false },
