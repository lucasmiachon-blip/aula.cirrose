...
6. Archetype CSS scoped: reutilizar componente de um archetype em OUTRO requer re-declarar layout/cores no contexto novo. (E18/E32)
7. data-background-color NAO funciona em deck.js (legacy Reveal.js). Usar background-color no CSS com seletor #slide-id .slide-inner. (E31/E34/E39)
